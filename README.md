...
* **Visualización de Datos & BI**: Matplotlib, Seaborn, Tableua
...
1. **Ingesta y Limpieza de Datos (Data Quality)**:
   * Eliminación de registros duplicados en el conjunto de órdenes.
...
2. **Auditoría Financiera y de Márgenes**:
   ...
   * Análisis comparativo de rentabilidad bruta real por producto, categoría y región geográfica.
